...
var shortcuts = [
    {
        ...
        shortcuts: [
            ...
            { keys: 'F8 / Shift + Enter', effect: 'Show playlist [UI]' },
        ],
    },
    {
        category: 'Playback',
    ...
    },
    {
        category: 'Playlist',
        shortcuts: [
            { keys: '[Shift] Enter', effect: 'Show playlist' },
            { keys: '[Ctrl] P', effect: 'Shuffle playlist' },
            { keys: '[Ctrl] p', effect: 'Sort playlist' },
            { keys: '[Ctrl] R', effect: 'Reverse playlist' },
            { keys: 'P', effect: 'Loads all files from the currently playing files directory' },
            { keys: 'p', effect: 'Save playlist' },
        ],
    },
    {
    ...
    },
    {
        category: 'Misc',
        shortcuts: [
            { keys: 'Y', effect: 'Open YouTube search' },
            { keys: '[Ctrl] f', effect: 'Change YouTube video quality' },
        ],
    },
    {
        ...
        shortcuts: [
            ...
            { keys: 'PREVIOUS / NEXT', effect: 'Prev / Next video in playlist' }, // keyboard with multimedia keys
        ],
    },
];
