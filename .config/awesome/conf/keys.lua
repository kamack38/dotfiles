...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "expose all widnows", group = "client" }),
	...
	end, { description = "raise mpd volume", group = "hotkeys" }),
	awful.key({ shift }, "XF86AudioLowerVolume", function()
		awful.util.spawn("mpc vol -2")
	end, { description = "lower mpd volume", group = "hotkeys" }),
	...
	awful.key({ modkey, shift, ctrl }, "h", function()
		awful.tag.incncol(1, nil, true)
	end, { description = "increase the number of columns", group = "layout" }),
	awful.key({ modkey, shift, ctrl }, "l", function()
		awful.tag.incncol(-1, nil, true)
	end, { description = "decrease the number of columns", group = "layout" }),

	--- Change useless gap
	awful.key({ alt, ctrl }, "=", function()
